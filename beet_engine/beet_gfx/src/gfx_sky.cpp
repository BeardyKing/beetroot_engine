...
void gfx_create_sky_pipelines() {
    ...
    shaderStages[0] = gfx_load_shader("../assets/shaders/sky.vert.spv", VK_SHADER_STAGE_VERTEX_BIT);
    shaderStages[1] = gfx_load_shader("../assets/shaders/sky.frag.spv", VK_SHADER_STAGE_FRAGMENT_BIT);
