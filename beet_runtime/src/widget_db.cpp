...
//===INTERNAL_STRUCTS===================================================================================================
static SelectedPool s_selectedPool = {SELECTED_POOL_NONE};
...
SelectedPool *get_selected_pool_type() { return &s_selectedPool; }

int32_t *get_selected_pool_index() { return &s_selectedPoolItem; }
//======================================================================================================================
